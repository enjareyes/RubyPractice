...
It should return true if the three numbers could form the side lengths of a triangle 
and false otherwise.

The arguments don't correspond to specific sides. Don't worry about handling negative 
...
def valid_triangle(a, b, c)
	if ((a + b) > c) && ((a + c) > b) && ((b + c) > a)
		...
		puts "No such triangle exists."
	end

end

valid_triangle(3,5,4)
valid_triangle(1,10,100)
